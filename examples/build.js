...
var preloader = new _lib2['default']();
...
var Preloader = (function (_EventEmitter) {
    ...
    Preloader.prototype.register = function register(loader) {
    ...
    Preloader.prototype.load = function load(url) {
        if (!url) {
        ...
        var loader = this.loaders.get(opts.loader || this.getLoader(opts.url));
    ...
    Preloader.prototype.flush = function flush() {};

    /**
     * Tries to match filename extension with the loader required to load it
     */

    Preloader.prototype.getLoader = function getLoader(url) {
